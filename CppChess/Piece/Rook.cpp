...
Rook::Rook(Board* board, Side side) : Piece(board, side){
    mTexture =  board->getGame()->getTexture("Resources/Pieces/rook_" + std::string(1, side) + ".png");
}
...
Rook* Rook::copy(){
    Rook* newPiece = new Rook(mBoard, mSide);
